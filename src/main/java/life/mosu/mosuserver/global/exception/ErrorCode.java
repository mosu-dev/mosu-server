...
public enum ErrorCode {
    ...
    APPLICATION_SCHOOL_ALREADY_APPLIED(HttpStatus.CONFLICT, "이미 해당 학교를 예약하셨습니다."),
    SCHOOL_RESERVATION_EXPIRED(HttpStatus.GONE, "학교 예약 시간이 만료되었습니다."),
    APPLICATION_CREATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "신청 생성에 실패했습니다."),
